...
const HealthPage = (): JSX.Element => {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col px-6 py-10 lg:px-10 lg:py-14">
      <header data-rura-stagger className="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <Link
          href="/"
          className="rounded-full border border-slate-900/15 bg-white px-4 py-2 text-sm font-semibold text-ink transition hover:border-accent hover:text-accent"
        >
          Back to Home
        </Link>
      </header>
